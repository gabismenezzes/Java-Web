...
CREATE TABLE `bebe` (
  ...
  `nomedoPai` varchar(45) DEFAULT NULL,
  `horarioNascimento` time DEFAULT NULL,
  `parto` enum('NORMAL','CESAREA') DEFAULT NULL,
  `medicos` varchar(45) DEFAULT NULL,
  `ficounauti` tinyint DEFAULT NULL,
  PRIMARY KEY (`idbebe`),
